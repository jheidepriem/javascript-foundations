...
it('should have a favorite accessory top hat by default', function() {
...
it('should perform a spell', function() {
    var magician = new Magician({ name: 'Scott' });
...
it('should start with 10 confidence', function() {
    var magician = new Magician({ name: 'Leta' });

    assert.equal(magician.confidencePercentage, 10);
  });

it('should get more confident with more tricks', function() {
    var magician = new Magician({ name: 'Leta' });
...
it('should perform show stopper', function() {
...
it('should get more confident after performing show stopper', function() {
